...
Then, missing values for TN are reconstructed using the following logic.  These happen stepwise, first calculating missing NO23 and TKN, then finishing with TN.
