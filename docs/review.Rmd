...
* For corals, trends in percent cover are assessed using linear mixed-effects models.  It may be worth confirming trends using non-parametric analogs. There also does not appear to be a minimum year requirement, unlike trends tests for other habitats (i.e., water column). 