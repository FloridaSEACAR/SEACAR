...
1. `r fl`
     ...
     * File outputs: `r scrptout(fl)`
     * Potential issues: 
          * Lines 108: Year is dependent variable in the linear model, it should be the independent variable.
...
1. `r fl`
     ...
     * Steps by line number:
          ...
          * Lines 123 - 158: create linear mixed effects model of percent cover for each species groups vs year, random effect for program location ID, save as csv
     ...
     * File outputs: `r scrptout(fl)`
     * Potential issues: 
          * Lines 106: Year is dependent variable in the linear model, it should be the independent variable.
```{r}
fl <- scrpt$File[5]
```
1. `r fl`
...
1. `r fl`
     ...
     * Steps by line number:
          ...
          * Lines 124 - 159: create linear mixed effects model of percent cover for each species groups vs year, random effect for program location ID, save as csv
     ...
     * File outputs: `r scrptout(fl)`
     * Potential issues: 
          * Lines 107: Year is dependent variable in the linear model, it should be the independent variable.
```{r}
fl <- scrpt$File[7]
```
1. `r fl`
...
1. `r fl`
     ...
     * File outputs: `r scrptout(fl)`
     * Potential issues: 
          * Could not locate the input file Percent Cover - FLA SE-2021-Jul-26.csv
```{r}
fl <- scrpt$File[10]
```
1. `r fl`
